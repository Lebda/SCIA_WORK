...
//[assembly: System.Windows.Forms.AxHost.TypeLibraryTimeStamp("25.10.2017 23:46:23")]
...
namespace AxEP_3DLib {
    ...
    public class AxEP_3D : ESAAtl.AxESAAtlHost {
        ...
        public virtual void CopyToClipboardParametric(short clipboardFormat, short antialiasing, short fillBackground) {
            if ((this.ocx == null)) {
                throw new System.Windows.Forms.AxHost.InvalidActiveXStateException("CopyToClipboardParametric", System.Windows.Forms.AxHost.ActiveXInvokeKind.MethodInvoke);
            }
            this.ocx.CopyToClipboardParametric(clipboardFormat, antialiasing, fillBackground);
        }
        
        public virtual void Enable3DCtlWarning(short sEnable3DCtlWarning) {
            if ((this.ocx == null)) {
                throw new System.Windows.Forms.AxHost.InvalidActiveXStateException("Enable3DCtlWarning", System.Windows.Forms.AxHost.ActiveXInvokeKind.MethodInvoke);
            }
            this.ocx.Enable3DCtlWarning(sEnable3DCtlWarning);
        }
        
        public virtual void Set3DCtlWarning(string bstr3DCtlWarning) {
            if ((this.ocx == null)) {
